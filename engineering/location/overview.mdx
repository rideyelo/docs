...
| Which places are top locations? | `CommunityTopLocations` joined to `PlaceProfiles` | Refreshed at most every 24 hours |
...
| Top-location refresh | Every 24 hours, 40 candidates, 8 seconds each | `toplocations.go` |
...
| --- | --- | --- | --- |
| Presence | `internal/service/heartbeat`, `internal/data/redis/presence_cache.go` | `providers/HeartbeatProvider.tsx` | `src/sites/dashboard/pages/PresencePage.tsx` |
