...
- **Email changes block instead of creating.** The product page says Yelo recreates contacts as unsubscribed after prior contact. In code, prior contact without an observed opt-out blocks with `subscription_review_required`.
