...
| `cmd/import-pois`, `cmd/backfill-categories`, `cmd/contact-sync`, `cmd/sync-school-catalog` | One-shot operator tools. For the POI tools, see [Curated POIs and imports](/engineering/location/poi-catalog-and-imports) |
