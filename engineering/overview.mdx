...
<CardGroup cols={2}>
  ...
  <Card title="Authorization matrix" icon="shield-halved" href="/engineering/security/authorization-matrix">
    Every credential, middleware, and route group, and who can call what.
  </Card>
  <Card title="CI workflows" icon="gears" href="/engineering/ci/workflows">
    The GitHub Actions workflows in each repository and what triggers them.
  </Card>
  <Card title="Cookbook" icon="book" href="/engineering/cookbook">
    Step-by-step recipes for common changes, such as a job, a migration, or a new site.
  </Card>
  <Card title="E2E environment" icon="vial" href="/engineering/qa/e2e">
    Device E2E suites, the fixture control plane, and how to run them.
  </Card>
  <Card title="Architecture timeline" icon="clock-rotate-left" href="/engineering/history/timeline">
    How the codebase evolved, with the commits behind each milestone.
  </Card>
</CardGroup>
