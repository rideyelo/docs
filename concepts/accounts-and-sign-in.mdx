...
<Steps>
  ...
  <Step title="Verify a phone number">
    Every app account needs a verified phone number. If the user signs in with Apple or Google and the account has no phone yet, Yelo asks for one before finishing. Phone codes are five digits and are sent through Twilio Verify.
  </Step>
